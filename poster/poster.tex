...
% % % % %                 \vskip 1ex
		    ...
		    \begin{block}{Реализация UMAP}
		        \vskip-2ex
		        Применим алгоритм к данным о ценах криптовалют на протяжении 669 дней (см. рис \ref{pic}). Рассмотрим сформировавшийся кластер №1. Временные ряды, оказавшиеся в кластере, ведут себя наиболее похоже во времени. Они сильно коррелируют между собой:
		        \begin{figure}
    ...
    \begin{column}{.47\textwidth}
      \begin{beamercolorbox}[center,wd=\textwidth]{postercolumn}
        \begin{minipage}[T]{.95\textwidth} % tweaks the width, makes a new \textwidth
		  ...
		  \tcboxfit[width=27cm,height=15.6cm,title={\large Построение графа}, colback=white, colframe=mine,  borderline={0pt}{0pt}{black}]{
		  \begin{itemize}
		     \normalsize
		     \leftskip -0.3in
		...
		\tcboxfit[width=27cm,height=14cm,title={\large Снижение размерности}, colback=white, colframe=my,  borderline={0pt}{0pt}{black}]{
		    \begin{itemize}
		    \normalsize
		     \leftskip -0.3in
